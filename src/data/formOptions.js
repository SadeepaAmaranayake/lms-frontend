...
export function validateTimeRange(value) {
  ...
  if (endTime <= startTime) {
    return "The ending time must be later than the starting time.";
  }
...
export function validateZoomUrl(value) {
  try {
    ...
    return "Enter a valid URL such as https://zoom.us/j/123456789.";
  }
}
...
export function validateDuplicateStudentPhone(
  value,
  _values,
  context = {},
) {
  ...
  const duplicate = records.some(
    (student) =>
      ...
      normalizePhone(student.phone) === phone,
  );

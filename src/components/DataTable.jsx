        ...
        <table className="w-full min-w-[720px] border-collapse text-left">
          <thead className="bg-slate-50">
            <tr>
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-slate-500 hover:text-indigo-700"
                    >
                      {column.label}
              ...
              {showActions && (
                <th className="border-b border-slate-200 px-5 py-3.5 text-right text-xs font-bold uppercase tracking-wider text-slate-500">
                  Actions
                </th>
              )}
            </tr>

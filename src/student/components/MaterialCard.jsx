...
export default function MaterialCard({ material, paymentStatus, type }) {
  ...
  let message = null;
  if (paymentLocked) message = "Payment is required to access this file.";
  if (!material.fileAvailable) message = "This file is currently unavailable.";
  ...
  return (
    <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
      ...
      {message ? (
        ...
        <button
          type="button"
          onClick={() => window.alert("Development only: no protected file is connected yet.")}
